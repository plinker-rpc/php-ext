...
ZEND_BEGIN_ARG_INFO_EX(arginfo_plinker_endpoint_system_exec, 0, 0, 1)
	ZEND_ARG_INFO(0, cmd)
ZEND_END_ARG_INFO()
...
ZEPHIR_INIT_FUNCS(plinker_endpoint_system_method_entry) {
	...
	PHP_ME(Plinker_Endpoint_System, whoami, NULL, ZEND_ACC_PUBLIC)
	PHP_ME(Plinker_Endpoint_System, exec, arginfo_plinker_endpoint_system_exec, ZEND_ACC_PUBLIC)
	PHP_ME(Plinker_Endpoint_System, test, NULL, ZEND_ACC_PUBLIC)
	PHP_FE_END
};
